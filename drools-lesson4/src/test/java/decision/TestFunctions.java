...
public class TestFunctions {
	...
	public void checkDrl2() {
		...
		String drl = compiler.compile(ResourceFactory.newClassPathResource("com/decision5/decision5.xls"),
				InputType.XLS);
	...
	public void testDecision() {
		...
		KieSession kieSession = container.newKieSession("decision-rules5");
