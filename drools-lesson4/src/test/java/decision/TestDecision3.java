 ...
 **/
@Slf4j
public class TestDecision3 {

	@Test
	public void checkDrl2() {
		SpreadsheetCompiler compiler = new SpreadsheetCompiler();
		String drl = compiler.compile(ResourceFactory.newClassPathResource("com/decision2/decision2.xls"),
				InputType.XLS);
	...
	public void testDecision() {
		...
		KieSession kieSession = container.newKieSession("decision-rules2");
