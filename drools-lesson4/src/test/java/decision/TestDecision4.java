 ...
 **/
@Slf4j
public class TestDecision4 {

	@Test
	public void checkDrl2() {
		SpreadsheetCompiler compiler = new SpreadsheetCompiler();
		String drl = compiler.compile(ResourceFactory.newClassPathResource("com/decision3/decision3.xls"),
				InputType.XLS);
	...
	public void testDecision() {
		...
		KieSession kieSession = container.newKieSession("decision-rules3");
