...
import com.choupangxia.utils.GlobalUtil;
 ...
 **/
@Slf4j
public class TestDecision5 {

	@Test
	public void checkDrl2() {
		SpreadsheetCompiler compiler = new SpreadsheetCompiler();
		String drl = compiler.compile(ResourceFactory.newClassPathResource("com/decision4/decision4.xls"),
				InputType.XLS);
	...
	public void testDecision() {
		...
		KieSession kieSession = container.newKieSession("decision-rules4");
